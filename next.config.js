...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' *.youtube.com *.twitter.com *.vercel-insights.com *.calendly.com *.googletagmanager.com data: *.google-analytics.com plausible.io;
